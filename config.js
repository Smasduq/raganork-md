...
module.exports = {
    ...
    SESSION: (process.env.SESSION || process.env.SESSION_ID || '').trim() || 'Raganork~93f3df60ae08ccd267e7197cb8fd5619:46797567754659584755733d',
    ...
    SUDO: process.env.SUDO || "2347041543965",
